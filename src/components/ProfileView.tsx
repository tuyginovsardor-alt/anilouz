...
export const PROFILE_BACKGROUNDS = [
  { id: '1', title: '1. Crimson Horizon', ibbUrl: 'https://ibb.co/81K2tRJ', url: 'https://i.ibb.co/FbKPfwPw/photo-1-2026-08-05-22-37-08.jpg' },
  { id: '2', title: '2. Cyberpunk Red City', ibbUrl: 'https://ibb.co/mVFLPhvH', url: 'https://i.ibb.co/JRq1gBGk/photo-3-2026-08-05-22-37-08.jpg' },
  { id: '3', title: '3. Gojo Satoru Six Eyes', ibbUrl: 'https://ibb.co/5XDCRnq1', url: 'https://i.ibb.co/SXHt559P/photo-2-2026-08-05-22-37-08.jpg' },
  { id: '4', title: '4. Neon Anime Warrior', ibbUrl: 'https://ibb.co/hF2mgm6X', url: 'https://i.ibb.co/bM7wBcjr/photo-5-2026-08-05-22-37-08.jpg' },
  { id: '5', title: '5. Dark Demon Slayer Flame', ibbUrl: 'https://ibb.co/MyKMbNxG', url: 'https://i.ibb.co/3y55hyRV/photo-4-2026-08-05-22-37-08.jpg' },
  { id: '6', title: '6. Naruto Kurama Chakra', ibbUrl: 'https://ibb.co/4nN7611Y', url: 'https://i.ibb.co/JRd5S8kx/photo-8-2026-08-05-22-37-08.jpg' },
  { id: '7', title: '7. Purple Samurai Spirit', ibbUrl: 'https://ibb.co/0jyzyMnj', url: 'https://i.ibb.co/p6tqF3JK/photo-7-2026-08-05-22-37-08.jpg' },
  { id: '8', title: '8. Sung Jinwoo Shadow Monarch', ibbUrl: 'https://ibb.co/HD6j5MR8', url: 'https://i.ibb.co/27cmcJbg/photo-6-2026-08-05-22-37-08.jpg' },
  { id: '9', title: '9. Fire Katana Swordmaster', ibbUrl: 'https://ibb.co/LDkLJ5hs', url: 'https://i.ibb.co/Pz5SmWpV/photo-10-2026-08-05-22-37-09.jpg' },
  { id: '10', title: '10. Sunset Sakura Temple', ibbUrl: 'https://ibb.co/S7fh9xyw', url: 'https://i.ibb.co/FL4zcQ9t/photo-11-2026-08-05-22-37-09.jpg' },
  { id: '11', title: '11. Red Masked Anbu Assassin', ibbUrl: 'https://ibb.co/XfcK5ZBC', url: 'https://i.ibb.co/GfZwbfYn/photo-9-2026-08-05-22-37-08.jpg' },
  { id: '12', title: '12. Eren Yeager Titan Form', ibbUrl: 'https://ibb.co/cSyKJynB', url: 'https://i.ibb.co/rG6nnspX/photo-14-2026-08-05-22-37-09.jpg' },
  { id: '13', title: '13. Dark Dragon Armor Knight', ibbUrl: 'https://ibb.co/sYr6Cg7', url: 'https://i.ibb.co/QjpfGmpX/photo-13-2026-08-05-22-37-09.jpg' },
  { id: '14', title: '14. Itachi Uchiha Tsukuyomi', ibbUrl: 'https://ibb.co/5g7nM9ks', url: 'https://i.ibb.co/6RFG8TJv/photo-12-2026-08-05-22-37-09.jpg' },
  { id: '15', title: '15. Cyber City Golden Night', ibbUrl: 'https://ibb.co/27vQLX7r', url: 'https://i.ibb.co/4Z8GDBZL/photo-17-2026-08-05-22-37-09.jpg' },
  { id: '16', title: '16. Luffy Gear 5 Joyboy', ibbUrl: 'https://ibb.co/bgXYFCRH', url: 'https://i.ibb.co/FLP0xWX8/photo-16-2026-08-05-22-37-09.jpg' },
  { id: '17', title: '17. Goku Mastered Ultra Instinct', ibbUrl: 'https://ibb.co/wrBR16BY', url: 'https://i.ibb.co/7mFRQSh/photo-15-2026-08-05-22-37-09.jpg' },
  { id: '18', title: '18. Ryomen Sukuna Malevolent Shrine', ibbUrl: 'https://ibb.co/TB8zzL0N', url: 'https://i.ibb.co/YFN42NsC/photo-20-2026-08-05-22-37-09.jpg' },
  { id: '19', title: '19. Synthwave Highway Drive', ibbUrl: 'https://ibb.co/TDQXFDjY', url: 'https://i.ibb.co/HL5bPDvH/photo-19-2026-08-05-22-37-09.jpg' },
  { id: '20', title: '20. Ichigo Kurosaki Final Getsuga', ibbUrl: 'https://ibb.co/0VfwD9Nz', url: 'https://i.ibb.co/cXYG7v3h/photo-18-2026-08-05-22-37-09.jpg' },
  { id: '21', title: '21. Chainsaw Devil Denji', ibbUrl: 'https://ibb.co/wFh48nT1', url: 'https://i.ibb.co/Psm79QzV/photo-21-2026-08-05-22-37-09.jpg' },
  { id: '22', title: '22. Kyojuro Rengoku Flame Heart', ibbUrl: 'https://ibb.co/BVTdTk1q', url: 'https://i.ibb.co/Lzm3VqB7/photo-22-2026-08-05-22-37-09.jpg' },
  { id: '23', title: '23. Kakashi Lightning Blade', ibbUrl: 'https://ibb.co/vC79nJZd', url: 'https://i.ibb.co/Y7BVBkN7/photo-23-2026-08-05-22-37-09.jpg' },
  { id: '24', title: '24. Orange Minimalist Horizon', ibbUrl: 'https://ibb.co/XZ4SG6Jy', url: 'https://i.ibb.co/XrJbhYY3/photo-24-2026-08-05-22-37-09.jpg' },
  { id: '25', title: '25. Megumi Fushiguro Shadows', ibbUrl: 'https://ibb.co/C5pp05P4', url: 'https://i.ibb.co/GfGcXP4t/photo-25-2026-08-05-22-37-09.jpg' },
  { id: '26', title: '26. Roronoa Zoro Ashura', ibbUrl: 'https://ibb.co/gL6qTkbD', url: 'https://i.ibb.co/DfwR1RJG/photo-27-2026-08-05-22-37-09.jpg' },
  { id: '27', title: '27. Tomioka Giyuu Eleventh Form', ibbUrl: 'https://ibb.co/ccR6kk71', url: 'https://i.ibb.co/kVnzS9YG/photo-26-2026-08-05-22-37-09.jpg' },
  { id: '28', title: '28. Crimson Flame Phoenix', ibbUrl: 'https://ibb.co/ynp97fZs', url: 'https://i.ibb.co/nN8HKQ3D/photo-29-2026-08-05-22-37-09.jpg' },
  { id: '29', title: '29. Neon Cyberpunk Tokyo Sky', ibbUrl: 'https://ibb.co/Y73rKkrk', url: 'https://i.ibb.co/d8W6x3S/photo-28-2026-08-05-22-37-09.jpg' },
];
...
const sanitizeImageUrl = (url?: string): string => {
  if (!url) return PROFILE_BACKGROUNDS[0].url;
  if (url.includes('ibb.co/') && !url.includes('i.ibb.co/')) {
    const matched = PROFILE_BACKGROUNDS.find(b => b.ibbUrl === url || b.url === url);
    return matched ? matched.url : PROFILE_BACKGROUNDS[0].url;
  }
  return url;
};
...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  const [supabaseUrlInput, setSupabaseUrlInput] = useState(() => localStorage.getItem('anilo_supabase_url') || 'https://txcmkfltrzzzqwytzatq.supabase.co');
  const [supabaseAnonKeyInput, setSupabaseAnonKeyInput] = useState(() => localStorage.getItem('anilo_supabase_anon_key') || '');
      ...
      <div className="max-w-xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="bg-[#181822] border border-white/10 rounded-2xl overflow-hidden divide-y divide-white/5 shadow-2xl">
            ...
            {/* 3. Tizimga Kirish / Ro'yxatdan O'tish */}
            {onOpenAuth && (
              <button
                onClick={onOpenAuth}
                className="w-full flex items-center justify-between py-3.5 px-4 hover:bg-white/5 transition group"
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      referrerPolicy="no-referrer"
                      onError={(e) => {
                        e.currentTarget.src = PROFILE_BACKGROUNDS[0].url;
                      }}
                    />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
          <div className="w-full max-w-md bg-[#181824] border border-white/10 rounded-3xl p-6 shadow-2xl space-y-5">
            ...
            <div className="space-y-3 text-xs">
              ...
              {/* Supabase Baza Ulash */}
              <div className="p-3.5 rounded-2xl bg-[#111115] border border-orange-500/20 space-y-2.5">
                <div className="flex items-center justify-between">
                  <h4 className="font-bold text-orange-400">Supabase Baza Ulash</h4>
                  <span className="text-[10px] bg-orange-500/20 text-orange-300 font-mono px-2 py-0.5 rounded">
                    Database & Auth
                  </span>
                </div>
                <div>
                  <label className="block text-[11px] text-gray-400 mb-1">Supabase Project URL</label>
                  <input
                    type="text"
                    value={supabaseUrlInput}
                    onChange={(e) => setSupabaseUrlInput(e.target.value)}
                    placeholder="https://txcmkfltrzzzqwytzatq.supabase.co"
                    className="w-full bg-[#1e1d24] text-white border border-white/10 rounded-xl px-3 py-1.5 font-mono text-[11px] focus:outline-none focus:border-orange-500"
                  />
                </div>
                <div>
                  <label className="block text-[11px] text-gray-400 mb-1">Supabase Anon Key</label>
                  <input
                    type="password"
                ...
                <button
                  type="button"
                  onClick={() => {
                    if (supabaseUrlInput) localStorage.setItem('anilo_supabase_url', supabaseUrlInput.trim());
                    if (supabaseAnonKeyInput) localStorage.setItem('anilo_supabase_anon_key', supabaseAnonKeyInput.trim());
                    alert("Supabase parametrlari saqlandi! Sahifa qayta yuklanadi.");
                    window.location.reload();
                  }}
                  className="w-full py-2 bg-orange-500/20 hover:bg-orange-500/30 text-orange-300 font-bold border border-orange-500/30 rounded-xl text-[11px] transition"
                >
                  Supabase-ni Qayta Ulash (Reload)
                </button>
              </div>
            </div>

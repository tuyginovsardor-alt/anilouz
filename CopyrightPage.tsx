        ...
        <div className="animate-fade-in max-w-4xl mx-auto py-8 px-4 pb-20">
            ...
            <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Founder 1: Firdavs */}
                    <div className="group bg-gradient-to-br from-[#1a1a1a] to-black border border-orange-500/30 p-8 rounded-[2.5rem] relative overflow-hidden hover:border-orange-500/60 transition-all shadow-2xl hover:shadow-orange-900/20">
                        {/* Background Decor */}
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl font-black text-white mb-1 tracking-tight">Firdavs Abdurazzoqov</h3>
                            <div className="flex items-center gap-2 mb-6">
                                <span className="bg-orange-500/20 text-orange-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-orange-500/20">Founder</span>
                            ...
                            <div className="space-y-4 pt-4 border-t border-white/5">
                                <div className="flex items-center gap-4 text-zinc-300">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm font-bold">Navoiy viloyati</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 text-zinc-300">
                    ...
                    {/* Founder 2: Sardor */}
                    <div className="group bg-gradient-to-br from-[#1a1a1a] to-black border border-blue-500/30 p-8 rounded-[2.5rem] relative overflow-hidden hover:border-blue-500/60 transition-all shadow-2xl hover:shadow-blue-900/20">
                        {/* Background Decor */}
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl font-black text-white mb-1 tracking-tight">Sardor Tuyginov</h3>
                            <div className="flex items-center gap-2 mb-6">
                                <span className="bg-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-blue-500/20">Creator</span>
                                <span className="text-zinc-600 text-xs font-bold uppercase tracking-widest">/</span>
                            ...
                            <div className="space-y-4 pt-4 border-t border-white/5">
                                <div className="flex items-center gap-4 text-zinc-300">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Manzil</p>
                                        <span className="text-sm font-bold">Samarqand viloyati</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 text-zinc-300">

...
import { Play, Sparkles, ArrowRight, ShoppingBag, Crown } from 'lucide-react';
...
export const WelcomePage: React.FC<WelcomePageProps> = ({ onMovieClick, onSearch, onStart }) => {
  ...
  return (
    <div className="space-y-16 pb-32">
      {/* Cinematic Hero Section - Rasm Admin paneldan olinadi */}
      ...
      {/* NEW TRENDING CAROUSEL (Romb/Oval Shakl) */}
      ...
      <div id="trending" className="px-4 md:px-8 space-y-10 container mx-auto">
          <div className="flex items-center justify-between">
             <div className="flex items-center gap-4">
                <div className="w-1.5 h-10 bg-orange-600 rounded-full shadow-[0_0_10px_rgba(249,115,22,0.8)]"></div>
                <h2 className="text-3xl font-black tracking-tighter uppercase text-white">Barcha Animelar</h2>
             </div>
             <button onClick={onStart} className="text-xs font-bold text-zinc-500 hover:text-white uppercase tracking-widest transition-colors flex items-center gap-2">Barchasi <ArrowRight size={14}/></button>
          </div>

        ...
        <div className="container mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
            ...
            {isAuthenticated ? (
                <div className="flex items-center gap-4">
                    <button onClick={() => setIsMenuOpen(true)} className="w-10 h-10 rounded-sm border border-white/10 flex items-center justify-center bg-zinc-900 overflow-hidden hover:border-orange-500 transition-all">
